        ...
        <div class="myCarousel">
            <div class="row">
                <div class="col-sm-12 text-center">
                   <img src="img/logo.png" width="140px" height="118px"><br>
                    <h1><b><font color="#f8192e">Ideabook</font>Store</b></h1>
                    <hr>
                </div>
            </div>
...
<!-- Bagian footer -->
    ...
    <div class="row" style="background: black;">
      <nav class="footer">
            <footer class="copyright text-center"><p>&copy; Copyright Ideabook Store 2023</p></footer>
        </div>
      </nav>
    </div>
</body>
